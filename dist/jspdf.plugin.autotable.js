...
function printFullRow(row, isLastRow, rowspanCellsCached) {
...
function printRow(row, rowspanCellsCached) {
    var table = state_1.default().table;
    ...
    if (rowspanCellsCached !== undefined) {
        ...
        _.forIn(rowspanCellsCached, function (value) {
...
function addPage(rowspanCellsCached) {
    var table = state_1.default().table;
    common_1.applyUserStyles();
...
function printEmptyCellBorder(rowspanCellsCached) {
    ...
    table.cursor.x = table.margin('left');
    if (rowspanCellsCached !== undefined) {
        _.forIn(rowspanCellsCached, function (cell, key) {
            common_1.applyStyles(cell.styles);
            var fillStyle = common_1.getFillStyle(cell.styles);
            if (fillStyle) {
                state_1.default().doc.rect(table.cursor.x, table.cursor.y, cell.width, cell.height, fillStyle);
            }
...
var config_1 = __webpack_require__(2);
var htmlParser_1 = __webpack_require__(15);
var polyfills_1 = __webpack_require__(3);
var common_1 = __webpack_require__(1);
var state_1 = __webpack_require__(0);
var inputValidator_1 = __webpack_require__(17);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var cssParser_1 = __webpack_require__(16);
var state_1 = __webpack_require__(0);
