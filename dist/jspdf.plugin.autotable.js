...
;// CONCATENATED MODULE: ./src/documentHandler.ts
class DocHandler {
...
;// CONCATENATED MODULE: ./src/autoTableText.ts
/**
...
;// CONCATENATED MODULE: ./src/tablePrinter.ts
...
;// CONCATENATED MODULE: ./src/tableCalculator.ts
...
function createTable(jsPDFDoc, input) {
    const doc = new DocHandler(jsPDFDoc);
    const content = tableCalculator_parseContent(input, doc.scaleFactor());
