...
declare type Color = [number, number, number] | number | 'transparent' | false;
declare type MarginPadding = number | {
    top?: number;
    right?: number;
    bottom?: number;
    left?: number;
...
declare type CellType = null | string | number | boolean | CellDefinition;
declare type MultipleRowType = CellType[][] | {
    string: CellType;
}[];
declare type SingleRowType = CellType[] | {
    string: CellType;
};
